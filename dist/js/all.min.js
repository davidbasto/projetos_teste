...
angular.module("serialGenerator",[]),angular.module("serialGenerator").provider("serialGenerator",function(){var t=5;this.getLength=function(){return t},this.setLength=function(e){t=e},this.$get=function(){return{generate:function(){for(var e="";e.length<t;)e+=String.fromCharCode(Math.floor(64*Math.random())+32);return e}}}}),angular.module("ui",[]),angular.module("ui").run(["$templateCache",function(t){t.put("view/accordion.html",'<div class="ui-accordion-title" ng-click="open();">{{title}}</div><div class="ui-accordion-content" ng-show="isOpened" ng-transclude>{{title}}</div>')}]).directive("uiAccordions",function(){return{controller:["$scope","$element","$attrs",function(t,e,o){var n=[];this.registerAccordion=function(t){n.push(t)},this.closeAll=function(){n.forEach(function(t){t.isOpened=!1})}}]}}),angular.module("ui").directive("uiAccordion",function(){return{templateUrl:"view/accordion.html",transclude:!0,scope:{title:"@"},require:"^uiAccordions",link:function(t,e,o,n){n.registerAccordion(t),t.open=function(){n.closeAll(),t.isOpened=!0}}}}),angular.module("listaTelefonica",["ngMessages","serialGenerator","ui","ngRoute"]),angular.module("listaTelefonica").config(["$httpProvider",function(t){t.interceptors.push("timestampInterceptor"),t.interceptors.push("errorInterceptor"),t.interceptors.push("loadingInterceptor")}]),angular.module("listaTelefonica").config(["$routeProvider",function(t){t.when("/contatos",{templateUrl:"view/contatos.html",controller:"listaTelefonicaCtrl",resolve:{operadoras:["operadorasAPI",function(t){return t.getOperadoras()}],contatos:["contatosAPI",function(t){return t.getContatos()}]}}),t.when("/novoContato",{templateUrl:"view/novoContato.html",controller:"novoContatoCtrl",resolve:{operadoras:["operadorasAPI",function(t){return t.getOperadoras()}]}}),t.when("/detalhesContato/:id",{templateUrl:"view/detalhesContato.html",controller:"detalhesContatoCtrl",resolve:{contato:["contatosAPI","$route",function(t,e){return t.getContato(e.current.params.id)}]}}),t.when("/error",{templateUrl:"view/error.html"}),t.otherwise({redirectTo:"/contatos"})}]),angular.module("listaTelefonica").config(["serialGeneratorProvider",function(t){t.setLength(5)}]),angular.module("listaTelefonica").controller("detalhesContatoCtrl",["$scope","$routeParams","contato",function(t,e,o){t.contato=o.data}]),angular.module("listaTelefonica").controller("listaTelefonicaCtrl",["$scope","serialGenerator","operadoras","contatos","$filter",function(t,e,o,n,r){t.app=r("upper")("Lista Telefonica"),t.contatos=n.data,t.operadoras=o.data;var a=function(){i(t.contatos),c(t.contatos)},i=function(t){t.forEach(function(t){t.operadora.precoComImposto=u(t.operadora.preco)})},c=function(t){t.forEach(function(t){t.serial=e.generate()})};t.adicionarContato=function(o){o.serial=e.generate(),o.data=new Date,contatosAPI.saveContato(o).success(function(e){delete t.contato,t.contatoForm.$setPristine(),carregarContatos()})},t.apagarContatos=function(e){t.contatos=e.filter(function(t){if(!t.selecionado)return t}),t.verificaContatoSelecionado(t.contatos)};var l=0;t.verificaContatoSelecionado=function(e){console.log(l++),t.hasContatoSelecionado=e.some(function(t){return t.selecionado})},t.ordenarPor=function(e){t.criterioDeOrdenacao=e,t.direcaoDaOrdenacao=!t.direcaoDaOrdenacao};var u=function(t){var e=1.2;return t*e};t.reset=function(){t.contatos=angular.copy(t.contatos)},a()}]),angular.module("listaTelefonica").controller("novoContatoCtrl",["$scope","$location","serialGenerator","operadoras",function(t,e,o,n){console.log(n.data),t.operadoras=n.data,t.adicionarContato=function(n){n.serial=o.generate(),n.data=new Date,contatosAPI.saveContato(n).success(function(o){delete t.contato,t.contatoForm.$setPristine(),e.path("/contatos")})}}]),angular.module("listaTelefonica").directive("uiAlert",function(){return{templateUrl:"view/alert.html",replace:!0,restrict:"AE",scope:{title:"@"},transclude:!0}}),angular.module("listaTelefonica").directive("uiDate",["$filter",function(t){function e(e,o,n,r){var a=function(t){return t=t.replace(/[^0-9]+/g,""),t.length>2&&(t=t.substring(0,2)+"/"+t.substring(2)),t.length>5&&(t=t.substring(0,5)+"/"+t.substring(5,9)),t};o.bind("keyup",function(){r.$setViewValue(a(r.$viewValue)),r.$render()}),r.$parsers.push(function(t){if(10===t.length){var e=t.split("/");return console.log(e),new Date(e[2],e[1]-1,e[0]).getTime()}}),r.$formatters.push(function(e){return t("date")(e,"dd/MM/yyyy")})}return{require:"ngModel",link:e}}]),angular.module("listaTelefonica").filter("ellipsis",function(){return function(t,e){if(t.length<=e)return t;var o=t.substring(0,e||2)+"...";return o}}),angular.module("listaTelefonica").filter("name",function(){return function(t){var e=t.split(" "),o=e.map(function(t){return/^(da|de)$/.test(t)?t:t.charAt(0).toUpperCase()+t.substring(1).toLowerCase()});return o.join(" ")}}),angular.module("listaTelefonica").filter("upper",function(){var t=0;return function(e){if(console.log(t++),e)return e.toUpperCase(e)}}),angular.module("listaTelefonica").factory("errorInterceptor",["$q","$location",function(t,e){return{responseError:function(o){return 404===o.status&&e.path("/error"),t.reject(o)}}}]),angular.module("listaTelefonica").factory("loadingInterceptor",["$q","$rootScope","$timeout",function(t,e,o){return{request:function(t){return e.loading=!0,t},requestError:function(o){return e.loading=!1,t.reject(o)},response:function(t){return o(function(){e.loading=!1},500),t},responseError:function(o){return e.loading=!1,t.reject(o)}}}]),angular.module("listaTelefonica").factory("timestampInterceptor",function(){return{request:function(t){var e=t.url;if(e.indexOf("view")>-1)return t;var o=(new Date).getTime();return t.url=e+"?timestamp="+o,t}}}),angular.module("listaTelefonica").factory("contatosAPI",["$http","config",function(t,e){var o=function(){return t.get(e.baseUrl+"/contatos")},n=function(o){return t.get(e.baseUrl+"/contatos/"+o)},r=function(o){return t.post(e.baseUrl+"/contatos",o)};return{getContatos:o,getContato:n,saveContato:r}}]),angular.module("listaTelefonica").service("operadorasAPI",["$http","config",function(t,e){this.getOperadoras=function(){return t.get(e.baseUrl+"/operadoras")}}]),angular.module("listaTelefonica").provider("serialGenerator",["config",function(t){console.log(t);var e=5;this.getLength=function(){return e},this.setLength=function(t){e=t},this.$get=function(){return{generate:function(){for(var t="";t.length<e;)t+=String.fromCharCode(Math.floor(64*Math.random())+32);return t}}}}]),angular.module("listaTelefonica").constant("config",{baseUrl:"http://localhost:3412"});